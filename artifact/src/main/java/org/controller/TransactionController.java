...
public class TransactionController extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
 	  ...
 	  out.println("    <title>Transaction| Savio Bank</title>");
 	 ...
 	 out.println("                <li><a href='TransactionController'>TRANSACTION</a></li>");
 	  ...
 	  out.println("        <h2>Get Transaction History!!</h2>");
 	  out.println("        <form action='TransactionCont' method='POST'>");
 	  out.println("            <input type='password' name='pswd' placeholder='password' required>");
 	  out.println("            <br>");
 	  out.println("            <button type='submit'>Retrieve</button>");
 	  out.println("        </form>");
 	  out.println("    </div>");
 	  out.println("</body>");
 	  out.println("</html>");
